  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-40 right-32 w-24 h-24 border border-secondary rounded-full animate-float" style={{animationDelay: '2s'}}></div>
        <div className="absolute bottom-32 left-32 w-20 h-20 border border-primary-lighter rounded-full animate-float" style={{animationDelay: '4s'}}></div>
      </div>
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative animate-slide-up">
            ...
            <div className="absolute bottom-8 -left-4 bg-primary text-primary-foreground px-4 py-2 rounded-xl shadow-card animate-bounce" style={{animationDelay: '1s'}}>
